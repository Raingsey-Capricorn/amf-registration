 ...
 * @generated
 */
public class ArticlesCacheModel
	implements CacheModel<Articles>, Externalizable {
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof ArticlesCacheModel)) {
			return false;
		}

		ArticlesCacheModel articlesCacheModel = (ArticlesCacheModel)object;

		if (articleId == articlesCacheModel.articleId) {
			return true;
		}
	...
	public Articles toEntityModel() {
		...
		articlesImpl.setIssueNumber(issueNumber);

		if (title == null) {
			articlesImpl.setTitle("");
		}
		else {
			articlesImpl.setTitle(title);
		}

		if (author == null) {
			articlesImpl.setAuthor("");
		}
		else {
			articlesImpl.setAuthor(author);
		}

		articlesImpl.setOrder(order);

		if (content == null) {
			articlesImpl.setContent("");
		}
		else {
			articlesImpl.setContent(content);
		}

...
public class AMFArticlePersistenceImpl
	...
	protected AMFArticle removeImpl(AMFArticle amfArticle) {
		amfArticleToAMFIssueTableMapper.deleteLeftPrimaryKeyTableMappings(
	...
	public long[] getAMFIssuePrimaryKeys(long pk) {
		long[] pks = amfArticleToAMFIssueTableMapper.getRightPrimaryKeys(pk);
	 ...
	 */
	@Override
	public List<AMFArticle> getAMFIssueAMFArticles(long pk) {
		return getAMFIssueAMFArticles(pk, QueryUtil.ALL_POS, QueryUtil.ALL_POS);
	}
	...
	public List<AMFArticle> getAMFIssueAMFArticles(
		...
		return getAMFIssueAMFArticles(pk, start, end, null);
	}
	...
	public List<AMFArticle> getAMFIssueAMFArticles(
		...
		return amfArticleToAMFIssueTableMapper.getLeftBaseModels(
	...
	public boolean containsAMFIssue(long pk, long amfIssuePK) {
		return amfArticleToAMFIssueTableMapper.containsTableMapping(
			pk, amfIssuePK);
	}
	...
	public void addAMFIssue(long pk, long amfIssuePK) {
		AMFArticle amfArticle = fetchByPrimaryKey(pk);

		if (amfArticle == null) {
			amfArticleToAMFIssueTableMapper.addTableMapping(
				CompanyThreadLocal.getCompanyId(), pk, amfIssuePK);
		}
		else {
			amfArticleToAMFIssueTableMapper.addTableMapping(
				amfArticle.getCompanyId(), pk, amfIssuePK);
		}
	}
	 ...
	 */
	@Override
	public void addAMFIssue(long pk, AMFIssue amfIssue) {
		AMFArticle amfArticle = fetchByPrimaryKey(pk);
		...
		if (amfArticle == null) {
			...
			amfArticleToAMFIssueTableMapper.addTableMapping(
				amfArticle.getCompanyId(), pk, amfIssue.getPrimaryKey());
		}
	}
	...
	public void addAMFIssues(long pk, long[] amfIssuePKs) {
		...
		amfArticleToAMFIssueTableMapper.addTableMappings(
			companyId, pk, amfIssuePKs);
	}
	 ...
	 */
	@Override
	public void addAMFIssues(long pk, List<AMFIssue> amfIssues) {
		addAMFIssues(
			pk,
			ListUtil.toLongArray(amfIssues, AMFIssue.AMF_ISSUE_ID_ACCESSOR));
	}
	...
	public void clearAMFIssues(long pk) {
		amfArticleToAMFIssueTableMapper.deleteLeftPrimaryKeyTableMappings(pk);
	}
	...
	public void removeAMFIssue(long pk, long amfIssuePK) {
		amfArticleToAMFIssueTableMapper.deleteTableMapping(pk, amfIssuePK);
	}
	 ...
	 */
	@Override
	public void removeAMFIssue(long pk, AMFIssue amfIssue) {
		amfArticleToAMFIssueTableMapper.deleteTableMapping(
			pk, amfIssue.getPrimaryKey());
	}
	...
	public void removeAMFIssues(long pk, long[] amfIssuePKs) {
		amfArticleToAMFIssueTableMapper.deleteTableMappings(pk, amfIssuePKs);
	}
	 ...
	 */
	@Override
	public void removeAMFIssues(long pk, List<AMFIssue> amfIssues) {
		removeAMFIssues(
			pk,
			ListUtil.toLongArray(amfIssues, AMFIssue.AMF_ISSUE_ID_ACCESSOR));
	}
	...
	public void setAMFIssues(long pk, long[] amfIssuePKs) {
		Set<Long> newAMFIssuePKsSet = SetUtil.fromArray(amfIssuePKs);
		Set<Long> oldAMFIssuePKsSet = SetUtil.fromArray(
			amfArticleToAMFIssueTableMapper.getRightPrimaryKeys(pk));

		Set<Long> removeAMFIssuePKsSet = new HashSet<Long>(oldAMFIssuePKsSet);

		removeAMFIssuePKsSet.removeAll(newAMFIssuePKsSet);

		amfArticleToAMFIssueTableMapper.deleteTableMappings(
			pk, ArrayUtil.toLongArray(removeAMFIssuePKsSet));

		newAMFIssuePKsSet.removeAll(oldAMFIssuePKsSet);
		...
		amfArticleToAMFIssueTableMapper.addTableMappings(
			companyId, pk, ArrayUtil.toLongArray(newAMFIssuePKsSet));
	}
	 ...
	 */
	@Override
	public void setAMFIssues(long pk, List<AMFIssue> amfIssues) {
		try {
			long[] amfIssuePKs = new long[amfIssues.size()];

			for (int i = 0; i < amfIssues.size(); i++) {
				AMFIssue amfIssue = amfIssues.get(i);

				amfIssuePKs[i] = amfIssue.getPrimaryKey();
			}

			setAMFIssues(pk, amfIssuePKs);
		}
		catch (Exception exception) {
			throw processException(exception);
		}
	...
	public void activate(BundleContext bundleContext) {
		...
		amfArticleToAMFIssueTableMapper = TableMapperFactory.getTableMapper(
			"AMFNewsletter_amfissue_article#amfArticleId",
			"AMFNewsletter_amfissue_article", "companyId", "amfArticleId",
			"amfIssueId", this, AMFIssue.class);
	...
	protected TableMapper<AMFArticle, AMFIssue> amfArticleToAMFIssueTableMapper;

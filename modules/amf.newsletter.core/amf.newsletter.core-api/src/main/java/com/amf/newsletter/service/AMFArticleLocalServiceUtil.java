...
public class AMFArticleLocalServiceUtil {
	...
	public static void addAMFIssueAMFArticle(
		long amfIssueId, com.amf.newsletter.model.AMFArticle amfArticle) {

		getService().addAMFIssueAMFArticle(amfIssueId, amfArticle);
	}

	public static void addAMFIssueAMFArticle(
		long amfIssueId, long amfArticleId) {

		getService().addAMFIssueAMFArticle(amfIssueId, amfArticleId);
	}

	public static void addAMFIssueAMFArticles(
		long amfIssueId,
		java.util.List<com.amf.newsletter.model.AMFArticle> amfArticles) {

		getService().addAMFIssueAMFArticles(amfIssueId, amfArticles);
	}

	public static void addAMFIssueAMFArticles(
		long amfIssueId, long[] amfArticleIds) {

		getService().addAMFIssueAMFArticles(amfIssueId, amfArticleIds);
	}

	public static void clearAMFIssueAMFArticles(long amfIssueId) {
		getService().clearAMFIssueAMFArticles(amfIssueId);
	}
	...
	public static void deleteAMFIssueAMFArticle(
		long amfIssueId, com.amf.newsletter.model.AMFArticle amfArticle) {

		getService().deleteAMFIssueAMFArticle(amfIssueId, amfArticle);
	}

	public static void deleteAMFIssueAMFArticle(
		long amfIssueId, long amfArticleId) {

		getService().deleteAMFIssueAMFArticle(amfIssueId, amfArticleId);
	}

	public static void deleteAMFIssueAMFArticles(
		long amfIssueId,
		java.util.List<com.amf.newsletter.model.AMFArticle> amfArticles) {

		getService().deleteAMFIssueAMFArticles(amfIssueId, amfArticles);
	}

	public static void deleteAMFIssueAMFArticles(
		long amfIssueId, long[] amfArticleIds) {

		getService().deleteAMFIssueAMFArticles(amfIssueId, amfArticleIds);
	}
	...
	public static java.util.List<com.amf.newsletter.model.AMFArticle>
		...
		return getService().getAMFIssueAMFArticles(amfIssueId);
	}

	public static java.util.List<com.amf.newsletter.model.AMFArticle>
		getAMFIssueAMFArticles(long amfIssueId, int start, int end) {

		return getService().getAMFIssueAMFArticles(amfIssueId, start, end);
	}
	...
	public static java.util.List<com.amf.newsletter.model.AMFArticle>
		...
		return getService().getAMFIssueAMFArticles(
			amfIssueId, start, end, orderByComparator);
	}

	public static int getAMFIssueAMFArticlesCount(long amfIssueId) {
		return getService().getAMFIssueAMFArticlesCount(amfIssueId);
	}
	 ...
	 */
	public static long[] getAMFIssuePrimaryKeys(long amfArticleId) {
		return getService().getAMFIssuePrimaryKeys(amfArticleId);
	}
	...
	public static boolean hasAMFIssueAMFArticle(
		long amfIssueId, long amfArticleId) {

		return getService().hasAMFIssueAMFArticle(amfIssueId, amfArticleId);
	}

	public static boolean hasAMFIssueAMFArticles(long amfIssueId) {
		return getService().hasAMFIssueAMFArticles(amfIssueId);
	}

	public static void setAMFIssueAMFArticles(
		long amfIssueId, long[] amfArticleIds) {

		getService().setAMFIssueAMFArticles(amfIssueId, amfArticleIds);
	}

...
public interface AMFIssueLocalService
	 ...
	 */
	public void addAMFArticleAMFIssue(long amfArticleId, AMFIssue amfIssue);

	public void addAMFArticleAMFIssue(long amfArticleId, long amfIssueId);

	public void addAMFArticleAMFIssues(
		long amfArticleId, List<AMFIssue> amfIssues);
	...
	public void deleteAMFArticleAMFIssue(long amfArticleId, AMFIssue amfIssue);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AMFIssue> getAMFArticleAMFIssues(long amfArticleId);

...
public interface ArticlesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.amf.newsletters.service.impl.ArticlesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the articles local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ArticlesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Articles createArticles(long articleId);
	...
	public Articles deleteArticles(Articles articles);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Articles deleteArticles(long articleId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Articles fetchArticles(long articleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Articles fetchArticlesByUuidAndCompanyId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Articles getArticles(long articleId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Articles getArticlesByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Articles> getArticleses(int start, int end);

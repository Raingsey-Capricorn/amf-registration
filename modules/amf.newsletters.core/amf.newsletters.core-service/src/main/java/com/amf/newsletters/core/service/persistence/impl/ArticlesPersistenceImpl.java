...
package com.amf.newsletters.core.service.persistence.impl;

import com.amf.newsletters.core.exception.NoSuchArticlesException;
import com.amf.newsletters.core.model.Articles;
import com.amf.newsletters.core.model.impl.ArticlesImpl;
import com.amf.newsletters.core.model.impl.ArticlesModelImpl;
import com.amf.newsletters.core.service.persistence.ArticlesPersistence;
import com.amf.newsletters.core.service.persistence.impl.constants.NewsletterPersistenceConstants;
...
/**
 * The persistence implementation for the articles service.
 *
 * <p>
 ...
 * @generated
 */
@Component(service = ArticlesPersistence.class)
public class ArticlesPersistenceImpl
	extends BasePersistenceImpl<Articles> implements ArticlesPersistence {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use <code>ArticlesUtil</code> to access the articles persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static final String FINDER_CLASS_NAME_ENTITY =
		ArticlesImpl.class.getName();
	 ...
	 */
	@Override
	public List<Articles> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Articles> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<Articles> findByUuid(
	...
	public List<Articles> findByUuid(
		...
		if (useFinderCache) {
			list = (List<Articles>)finderCache.getResult(
				finderPath, finderArgs, this);

			if ((list != null) && !list.isEmpty()) {
				for (Articles articles : list) {
					if (!uuid.equals(articles.getUuid())) {
						list = null;
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_ARTICLES_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(ArticlesModelImpl.ORDER_BY_JPQL);
			}
			...
			try {
				...
				list = (List<Articles>)QueryUtil.list(
	...
	public Articles findByUuid_First(
		...
		Articles articles = fetchByUuid_First(uuid, orderByComparator);
		...
		throw new NoSuchArticlesException(sb.toString());
	}
	...
	public Articles fetchByUuid_First(
		...
		List<Articles> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Articles findByUuid_Last(
		...
		Articles articles = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Articles[] findByUuid_PrevAndNext(
		...
		Articles articles = findByPrimaryKey(articleId);
		...
		try {
			...
			Articles[] array = new ArticlesImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, articles, uuid, orderByComparator, true);

			array[1] = articles;

			array[2] = getByUuid_PrevAndNext(
				session, articles, uuid, orderByComparator, false);
	...
	protected Articles getByUuid_PrevAndNext(
		Session session, Articles articles, String uuid,
		OrderByComparator<Articles> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(articles)) {
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_ARTICLES_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(articles.uuid IS NULL OR articles.uuid = '')";
	 ...
	 */
	@Override
	public List<Articles> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	 ...
	 */
	@Override
	public List<Articles> findByUuid_C(
	...
	public List<Articles> findByUuid_C(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Articles articles : list) {
					if (!uuid.equals(articles.getUuid()) ||
						(companyId != articles.getCompanyId())) {
	...
	public Articles findByUuid_C_First(
		...
		Articles articles = fetchByUuid_C_First(
	...
	public Articles fetchByUuid_C_First(
		...
		List<Articles> list = findByUuid_C(
	...
	public Articles findByUuid_C_Last(
		...
		Articles articles = fetchByUuid_C_Last(
			uuid, companyId, orderByComparator);
	...
	public Articles[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, articles, uuid, companyId, orderByComparator, true);

			array[1] = articles;

			array[2] = getByUuid_C_PrevAndNext(
				session, articles, uuid, companyId, orderByComparator, false);
	...
	protected Articles getByUuid_C_PrevAndNext(
		Session session, Articles articles, String uuid, long companyId,
		OrderByComparator<Articles> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 =
		"(articles.uuid IS NULL OR articles.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Articles> findByArticleId(long articleId) {
	 ...
	 */
	@Override
	public List<Articles> findByArticleId(long articleId, int start, int end) {
	 ...
	 */
	@Override
	public List<Articles> findByArticleId(
	...
	public List<Articles> findByArticleId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Articles articles : list) {
					if (articleId != articles.getArticleId()) {
						list = null;
	...
	public Articles findByArticleId_First(
		...
		Articles articles = fetchByArticleId_First(
	...
	public Articles fetchByArticleId_First(
		...
		List<Articles> list = findByArticleId(
	...
	public Articles findByArticleId_Last(
		...
		Articles articles = fetchByArticleId_Last(articleId, orderByComparator);
	...
	public ArticlesPersistenceImpl() {
		...
		setModelClass(Articles.class);

		setModelImplClass(ArticlesImpl.class);
	...
	public void cacheResult(Articles articles) {
		entityCache.putResult(
			ArticlesImpl.class, articles.getPrimaryKey(), articles);
	}
	 ...
	 */
	@Override
	public void cacheResult(List<Articles> articleses) {
		for (Articles articles : articleses) {
			if (entityCache.getResult(
					ArticlesImpl.class, articles.getPrimaryKey()) == null) {

				cacheResult(articles);
			}
		}
	}

	/**
	 * Clears the cache for all articleses.
	 *
	 * <p>
	...
	public void clearCache() {
		entityCache.clearCache(ArticlesImpl.class);
	...
	/**
	 * Clears the cache for the articles.
	 *
	 * <p>
	 * The <code>EntityCache</code> and <code>FinderCache</code> are both cleared by this method.
	 * </p>
	 */
	@Override
	public void clearCache(Articles articles) {
		entityCache.removeResult(ArticlesImpl.class, articles);
	}

	@Override
	public void clearCache(List<Articles> articleses) {
		for (Articles articles : articleses) {
			entityCache.removeResult(ArticlesImpl.class, articles);
		}
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(ArticlesImpl.class, primaryKey);
		}
	}
	...
	public Articles create(long articleId) {
		...
		articles.setNew(true);
		articles.setPrimaryKey(articleId);

		String uuid = PortalUUIDUtil.generate();

		articles.setUuid(uuid);

		articles.setCompanyId(CompanyThreadLocal.getCompanyId());
	 ...
	 * Removes the articles with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the articles
	 * @return the articles that was removed
	 * @throws NoSuchArticlesException if a articles with the primary key could not be found
	 */
	@Override
	public Articles remove(Serializable primaryKey)
		throws NoSuchArticlesException {
		...
		try {
			...
			Articles articles = (Articles)session.get(
				ArticlesImpl.class, primaryKey);
			...
			if (articles == null) {
				...
				throw new NoSuchArticlesException(
					_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + primaryKey);
			}

			return remove(articles);
		}
		catch (NoSuchArticlesException noSuchEntityException) {
	...
	@Override
	protected Articles removeImpl(Articles articles) {
		Session session = null;

		try {
			session = openSession();

			if (!session.contains(articles)) {
				articles = (Articles)session.get(
					ArticlesImpl.class, articles.getPrimaryKeyObj());
			}
	...
	public Articles updateImpl(Articles articles) {
		boolean isNew = articles.isNew();

		if (!(articles instanceof ArticlesModelImpl)) {
			InvocationHandler invocationHandler = null;

			if (ProxyUtil.isProxyClass(articles.getClass())) {
				invocationHandler = ProxyUtil.getInvocationHandler(articles);

				throw new IllegalArgumentException(
					"Implement ModelWrapper in articles proxy " +
						invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Articles implementation " +
					articles.getClass());
		}

		ArticlesModelImpl articlesModelImpl = (ArticlesModelImpl)articles;

		if (Validator.isNull(articles.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew && (articles.getCreateDate() == null)) {
			if (serviceContext == null) {
				articles.setCreateDate(now);
			}
			else {
				articles.setCreateDate(serviceContext.getCreateDate(now));
			}
		}

		if (!articlesModelImpl.hasSetModifiedDate()) {
			if (serviceContext == null) {
				articles.setModifiedDate(now);
			}
			else {
				articles.setModifiedDate(serviceContext.getModifiedDate(now));
			}
		}
		...
		try {
			...
			if (isNew) {
				...
				articles = (Articles)session.merge(articles);
			}
		}
		catch (Exception exception) {
			throw processException(exception);
		...
		entityCache.putResult(
			ArticlesImpl.class, articlesModelImpl, false, true);

		if (isNew) {
			articles.setNew(false);
		}

		articles.resetOriginalValues();

		return articles;
	}

	/**
	 * Returns the articles with the primary key or throws a <code>com.liferay.portal.kernel.exception.NoSuchModelException</code> if it could not be found.
	 *
	 * @param primaryKey the primary key of the articles
	 * @return the articles
	 * @throws NoSuchArticlesException if a articles with the primary key could not be found
	 */
	@Override
	public Articles findByPrimaryKey(Serializable primaryKey)
		throws NoSuchArticlesException {

		Articles articles = fetchByPrimaryKey(primaryKey);
	 ...
	 */
	@Override
	public List<Articles> findAll(int start, int end) {
	...
	public List<Articles> findAll(
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(_SQL_SELECT_ARTICLES);
				...
				sql = _SQL_SELECT_ARTICLES;

				sql = sql.concat(ArticlesModelImpl.ORDER_BY_JPQL);
			}
	...
	public int countAll() {
		...
		if (count == null) {
			...
			try {
				...
				Query query = session.createQuery(_SQL_COUNT_ARTICLES);
	...
	protected String getSelectSQL() {
		return _SQL_SELECT_ARTICLES;
	}

	@Override
	protected Map<String, Integer> getTableColumnsMap() {
		return ArticlesModelImpl.TABLE_COLUMNS_MAP;
	}

	/**
	 * Initializes the articles persistence.
	 */
	@Activate
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new ArticlesModelArgumentsResolver(),
			MapUtil.singletonDictionary(
				"model.class.name", Articles.class.getName()));
	...
	public void deactivate() {
		entityCache.removeCache(ArticlesImpl.class.getName());
	...
	private static final String _SQL_SELECT_ARTICLES =
		"SELECT articles FROM Articles articles";

	private static final String _SQL_SELECT_ARTICLES_WHERE =
		"SELECT articles FROM Articles articles WHERE ";

	private static final String _SQL_COUNT_ARTICLES =
		"SELECT COUNT(articles) FROM Articles articles";

	private static final String _SQL_COUNT_ARTICLES_WHERE =
		"SELECT COUNT(articles) FROM Articles articles WHERE ";

	private static final String _ORDER_BY_ENTITY_ALIAS = "articles.";

	private static final String _NO_SUCH_ENTITY_WITH_PRIMARY_KEY =
		"No Articles exists with the primary key ";

	private static final String _NO_SUCH_ENTITY_WITH_KEY =
		"No Articles exists with the key {";

	private static final Log _log = LogFactoryUtil.getLog(
		ArticlesPersistenceImpl.class);
	...
	private static class ArticlesModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			ArticlesModelImpl articlesModelImpl = (ArticlesModelImpl)baseModel;

			long columnBitmask = articlesModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(articlesModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						articlesModelImpl.getColumnBitmask(columnName);
				}
		...
		private Object[] _getValue(
			ArticlesModelImpl articlesModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = articlesModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
					arguments[i] = articlesModelImpl.getColumnValue(columnName);
				}
			}

...
/**
 * Provides the local service interface for Issues. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see IssuesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IssuesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.amf.newsletters.core.service.impl.IssuesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the issues local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IssuesLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Issues createIssues(long issueId);
	...
	public Issues deleteIssues(Issues issues);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Issues deleteIssues(long issueId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Issues fetchIssues(long issueId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Issues fetchIssuesByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Issues getIssues(long issueId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Issues getIssuesByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Issues> getIssueses(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Issues> getIssuesesByUuidAndCompanyId(

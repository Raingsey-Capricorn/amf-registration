...
/**
 * This class is used by SOAP remote services, specifically {@link com.amf.newsletters.core.service.http.ArticlesServiceSoap}.
 *
...
public class ArticlesSoap implements Serializable {
	...
	public static ArticlesSoap[] toSoapModels(List<Articles> models) {
		List<ArticlesSoap> soapModels = new ArrayList<ArticlesSoap>(
			models.size());

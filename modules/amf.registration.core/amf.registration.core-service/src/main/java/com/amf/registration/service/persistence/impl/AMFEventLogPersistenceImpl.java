...
public class AMFEventLogPersistenceImpl
	...
	/**
	 * Returns all the amf event logs where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @return the matching amf event logs
	 */
	@Override
	public List<AMFEventLog> findByUserID(long userId) {
		return findByUserID(userId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the amf event logs where userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>AMFEventLogModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<AMFEventLog> findByUserID(long userId, int start, int end) {
		return findByUserID(userId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the amf event logs where userId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>AMFEventLogModelImpl</code>.
	 * </p>
	 ...
	 */
	@Override
	public List<AMFEventLog> findByUserID(
	...
	public List<AMFEventLog> findByUserID(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (AMFEventLog amfEventLog : list) {
					if (userId != amfEventLog.getUserId()) {
						list = null;
	...
	/**
	 * Returns the first amf event log in the ordered set where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching amf event log
	 ...
	 */
	@Override
	public AMFEventLog findByUserID_First(
			long userId, OrderByComparator<AMFEventLog> orderByComparator)
		throws NoSuchAMFEventLogException {

		AMFEventLog amfEventLog = fetchByUserID_First(
	 ...
	 */
	@Override
	public AMFEventLog fetchByUserID_First(
		long userId, OrderByComparator<AMFEventLog> orderByComparator) {

		List<AMFEventLog> list = findByUserID(userId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last amf event log in the ordered set where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching amf event log
	 ...
	 */
	@Override
	public AMFEventLog findByUserID_Last(
			long userId, OrderByComparator<AMFEventLog> orderByComparator)
		throws NoSuchAMFEventLogException {

		AMFEventLog amfEventLog = fetchByUserID_Last(userId, orderByComparator);
	 ...
	 */
	@Override
	public AMFEventLog fetchByUserID_Last(
		long userId, OrderByComparator<AMFEventLog> orderByComparator) {
		...
		List<AMFEventLog> list = findByUserID(
	...
	/**
	 * Returns the amf event logs before and after the current amf event log in the ordered set where userId = &#63;.
	 *
	 * @param amfEventLogId the primary key of the current amf event log
	 * @param userId the user ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public AMFEventLog[] findByUserID_PrevAndNext(
			long amfEventLogId, long userId,
			OrderByComparator<AMFEventLog> orderByComparator)
		throws NoSuchAMFEventLogException {
		...
		try {
			...
			array[0] = getByUserID_PrevAndNext(
				session, amfEventLog, userId, orderByComparator, true);

			array[1] = amfEventLog;

			array[2] = getByUserID_PrevAndNext(
				session, amfEventLog, userId, orderByComparator, false);
	...
	protected AMFEventLog getByUserID_PrevAndNext(
		Session session, AMFEventLog amfEventLog, long userId,
		OrderByComparator<AMFEventLog> orderByComparator, boolean previous) {
	...
	/**
	 * Removes all the amf event logs where userId = &#63; from the database.
	 *
	 * @param userId the user ID
	 */
	@Override
	...
	/**
	 * Returns the number of amf event logs where userId = &#63;.
	 *
	 * @param userId the user ID
	 * @return the number of matching amf event logs
	 */
	...
	public void activate(BundleContext bundleContext) {
		...
		amfEventLogToAMFUserTableMapper = TableMapperFactory.getTableMapper(
			"AMFRegistration_eventlog#amfEventLogId",
			"AMFRegistration_eventlog", "companyId", "amfEventLogId",

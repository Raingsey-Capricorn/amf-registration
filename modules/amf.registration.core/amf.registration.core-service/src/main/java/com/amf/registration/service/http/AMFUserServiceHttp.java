...
public class AMFUserServiceHttp {
	...
	public static com.amf.registration.model.AMFUser addAMFUser(
		...
		try {
			MethodKey methodKey = new MethodKey(
				AMFUserServiceUtil.class, "addAMFUser",
			...
			return (com.amf.registration.model.AMFUser)returnObj;
		}
	...
	public static java.util.List<com.amf.registration.model.AMFUser>
		...
		try {
			MethodKey methodKey = new MethodKey(
				AMFUserServiceUtil.class, "getAMFUsersByKeywords",
				_getAMFUsersByKeywordsParameterTypes1);
			...
			return (java.util.List<com.amf.registration.model.AMFUser>)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	public static long getAMFUsersCountByKeywords(
		...
		try {
			MethodKey methodKey = new MethodKey(
				AMFUserServiceUtil.class, "getAMFUsersCountByKeywords",
				_getAMFUsersCountByKeywordsParameterTypes2);
	...
	public static com.amf.registration.model.AMFUser getAmfUser(
			HttpPrincipal httpPrincipal, long amdUserId)
		throws com.liferay.portal.kernel.exception.PortalException {

		try {
			MethodKey methodKey = new MethodKey(
				AMFUserServiceUtil.class, "getAmfUser",
				_getAmfUserParameterTypes3);
	...
	private static final Class<?>[] _getAMFUsersCountByKeywordsParameterTypes2 =
		new Class[] {long.class, String.class};
	private static final Class<?>[] _getAmfUserParameterTypes3 = new Class[] {
		long.class
	};
